...
public class StatisticsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        usersList= new ArrayList<>(dataBase.viewUserDetails(useremailId));

        arryFD = dataBase.searchCategory(FD,usersList.get(0).getId());
        arryRent = dataBase.searchCategory(Rent,usersList.get(0).getId());
        arryAT = dataBase.searchCategory(AT,usersList.get(0).getId());
        arryShop = dataBase.searchCategory(Shop,usersList.get(0).getId());
        arryBU = dataBase.searchCategory(BU,usersList.get(0).getId());
        arryBS = dataBase.searchCategory(BS,usersList.get(0).getId());
        arryHF = dataBase.searchCategory(HF,usersList.get(0).getId());
